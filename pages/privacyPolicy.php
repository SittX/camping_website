...
?>
    ...
    <ul>
        ...
        <li>
            <p><strong>Website</strong> refers to Global Wild Swimming and Camping, accessible from <a
                        href="http://localhost/camping_website" rel="external nofollow noopener" target="_blank">http://localhost/camping_website</a>
            </p>
        </li>
        <li>
    ...
    <ul>
        ...
        <li>
            <p>By visiting this page on our website: <a href="http://localhost/camping_website/pages/contact.php"
                                                        rel="external nofollow noopener" target="_blank">http://localhost/camping_website/pages/contact.php</a>
            </p>
        </li>
    </ul>
