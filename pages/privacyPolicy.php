...
<ul>
    ...
    <li>
        <p><strong>Website</strong> refers to Global Wild Swimming and Camping, accessible from <a href="http://localhost/camping_website" rel="external nofollow noopener" target="_blank">http://localhost/camping_website</a></p>
    </li>
    <li>
...
<p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
    ...
    browser. Learn more about cookies on the <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" target="_blank">Privacy Policies website</a> article.</p>
...
<ul>
    <li>
        <p>By email: business@gwsc.com</p>
    </li>
    <li>
        <p>By visiting this page on our website: <a href="http://localhost/camping_website/pages/contact.php" rel="external nofollow noopener" target="_blank">http://localhost/camping_website/pages/contact.php</a>
        </p>
    </li>
</ul>
