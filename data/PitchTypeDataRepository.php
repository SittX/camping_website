...
class PitchTypeDataRepository implements DataRepository
{
    ...
    {
        $query = "SELECT * FROM PitchType WHERE pitch_type_id = ?";
        $paramTypes = "i";
    ...
    {
        $query = "INSERT INTO PitchType(title,pitch_description) VALUES (?,?)";
        $paramTypes = "ss";
        $stmt = prepareAndExecuteQuery($this->connection, $query, $paramTypes, $data->getTitle(), $data->getDescription());
    ...
    {
        $pitchType = new PitchType($row["title"], $row['pitch_description']);
