...
class CampSiteDataRepository implements DataRepository
{
    ...
    public function insert($data): int
    {
        ...
        $paramTypes = "ssissssi";
        $stmt = prepareAndExecuteQuery($this->connection, $query, $paramTypes, $data->getName(),$data->getLocation(), $data->getPrice(), $data->getDescription(), $data->getLocalAttraction(), $data->getFeatures(), $data->getNoticeNote(), $data->getPitchTypeId());
    ...
    {
        $campsite = new CampSite($row['name'],$row['location'], $row['description'], $row['local_attraction'], $row['features'], $row['notice_note'], $row['pitch_type_id'], $row['price']);
